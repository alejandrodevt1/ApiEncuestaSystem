...
namespace ApiEncuestaSystem.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Encuesta_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsuariosEncuesta", x => new { x.UsuarioId, x.EncuestaID });
                    table.ForeignKey(
                        name: "FK_UsuariosEncuesta_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UsuariosEncuesta_Encuesta_EncuestaID",
                        column: x => x.EncuestaID,
                        principalTable: "Encuesta",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UsuarioId = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    EncuestaId = table.Column<int>(type: "int", nullable: false),
                    PreguntaID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Respuestas_UsuariosEncuesta_UsuarioId_EncuestaId",
                        columns: x => new { x.UsuarioId, x.EncuestaId },
                        principalTable: "UsuariosEncuesta",
                        principalColumns: new[] { "UsuarioId", "EncuestaID" });
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Respuestas_UsuarioId_EncuestaId",
                table: "Respuestas",
                columns: new[] { "UsuarioId", "EncuestaId" });

            migrationBuilder.CreateIndex(
                name: "IX_UsuariosEncuesta_EncuestaID",
                table: "UsuariosEncuesta",
                column: "EncuestaID");
        }
